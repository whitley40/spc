...
<?php
  ...
  <section class="content-banner our-story-banner section-blue">
  ...
  <!-- ############ Our Story - white  - career ############ -->

  <section class="our-story-two">

  <div class="content-container">

  <h2><?php the_field('story_title'); ?></h2>

  <?php the_field('story_detail'); ?>
  ...
  <section class="our-story-three">
    
    <!-- logo - svg -->
<svg version="1.1" id="spc-logo-story" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<!-- ///END logo - svg -->
  ...
  <!-- ############ Our Story - white  - more ############ -->

  <section class="our-story-four">

  <div class="content-container">

    <h2><?php the_field('associates_title'); ?></h2>

    <?php the_field('associates_detail'); ?>
